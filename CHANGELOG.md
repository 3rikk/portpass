...
- Extra destinations for the Faroe Islands, Åland, Guernsey, Jersey and the Isle of Man, with territory-specific conditions and no invented passport nationalities.
- A dedicated **Settlement blocs** map view above Advanced. It is independent of the visitor’s wallet and personal map.
- A colour key for all supported bloc and agreement groups, filtering by selected group, country and territory detail dialogs, and map markers for small states and territories.
- Multicolour dashed map patterns for countries covered by more than one settlement bloc or agreement.
...
- Added rule and browser coverage for settlement corridors, overlaps, dates, restrictions, profiles, territories, map key filtering, dashed fills, keyboard access, themes, responsive layout and JPEG export.
