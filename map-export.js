...
(function() {
  ...
  function initExportControls() {
    ...
    style.textContent = `#share-dialog.share-dialog-polished{width:min(1380px,calc(100vw - 32px));max-height:calc(100dvh - 32px);overflow:hidden;padding:24px 28px}#share-dialog.share-dialog-polished[open]{display:flex;flex-direction:column}#share-dialog.share-dialog-polished .dialog-heading{flex:0 0 auto;align-items:flex-start;gap:14px;margin-bottom:16px}#share-dialog.share-dialog-polished .dialog-heading>div{min-width:0}#share-dialog.share-dialog-polished .close{width:34px;height:34px;display:grid;place-items:center;flex:0 0 auto}#share-dialog.share-dialog-polished .share-top-actions{margin-left:auto;display:flex;align-items:center;gap:8px;flex-wrap:wrap;justify-content:flex-end}#share-dialog.share-dialog-polished .share-top-actions a,#share-dialog.share-dialog-polished .share-top-actions button{display:inline-flex;align-items:center;justify-content:center;min-height:34px;padding:8px 13px;border:1px solid var(--line);border-radius:8px;background:var(--palette-soft-2,#f0f2ed);color:var(--ink);font-size:11px;text-decoration:none;white-space:nowrap}#share-dialog.share-dialog-polished .share-top-actions a{background:var(--green);border-color:var(--green);color:var(--surface);font-weight:600}html:root[data-theme="dark"] #share-dialog.share-dialog-polished .share-top-actions a{color:var(--paper)}#share-dialog.share-dialog-polished .share-dialog-hidden-copy{position:absolute!important;width:1px!important;height:1px!important;margin:-1px!important;padding:0!important;overflow:hidden!important;clip:rect(0 0 0 0)!important;white-space:nowrap!important;border:0!important}#share-dialog.share-dialog-polished .share-preview-frame{flex:1 1 auto;min-height:0;display:grid;place-items:center;margin:0;padding:14px;border:1px solid color-mix(in srgb,var(--ink) 12%,var(--line));border-radius:16px;background:linear-gradient(135deg,color-mix(in srgb,var(--surface) 72%,var(--paper)),var(--surface));box-shadow:inset 0 0 0 1px color-mix(in srgb,var(--surface) 65%,transparent),0 14px 35px color-mix(in srgb,var(--ink) 10%,transparent)}#share-dialog.share-dialog-polished #share-preview{display:block;max-width:100%;max-height:calc(100dvh - 255px);width:auto;height:auto;border:1px solid color-mix(in srgb,var(--ink) 16%,var(--line));border-radius:9px;background:var(--paper);box-shadow:0 8px 28px color-mix(in srgb,var(--ink) 12%,transparent);object-fit:contain}#share-dialog.share-dialog-polished #share-preview[hidden]{display:none}#share-dialog.share-dialog-polished .export-theme-controls{flex:0 0 auto;margin:12px 0 0;padding:10px 12px;border:1px solid var(--line);border-radius:12px;background:color-mix(in srgb,var(--surface) 92%,var(--paper));color:var(--ink)}.export-theme-head{display:flex;align-items:center;justify-content:space-between;gap:12px}.export-theme-head strong{display:block;font-size:11px}.export-theme-head small{display:block;margin-top:3px;color:var(--muted);font-size:9px}.export-theme-mode{border:1px solid var(--line);background:var(--palette-soft-3,#ecefe8);padding:3px;border-radius:8px;display:flex;gap:3px}.export-theme-mode button{padding:7px 12px;border-radius:6px;font-size:10px;color:var(--muted)}.export-theme-mode button.active{background:var(--surface);color:var(--ink);box-shadow:0 2px 5px #25372b0b}.export-palette-picker{display:flex;justify-content:center;gap:8px;margin-top:8px}.export-palette-picker button{width:18px;height:18px;min-width:18px;padding:0;border-radius:50%;border:1px solid color-mix(in srgb,var(--ink) 18%,transparent);background:var(--swatch);box-shadow:0 0 0 2px transparent}.export-palette-picker button.active{box-shadow:0 0 0 2px var(--surface),0 0 0 4px color-mix(in srgb,var(--ink) 48%,transparent)}.export-theme-controls[aria-busy="true"] button{opacity:.55;pointer-events:none}@media(max-width:720px){#share-dialog.share-dialog-polished{padding:20px;width:min(100vw - 22px,620px)}#share-dialog.share-dialog-polished .dialog-heading{flex-wrap:wrap}#share-dialog.share-dialog-polished .share-top-actions{order:3;width:100%;justify-content:flex-start;margin-left:0}#share-dialog.share-dialog-polished #share-preview{max-height:calc(100dvh - 330px)}#share-dialog.share-dialog-polished .share-preview-frame{padding:9px}.export-theme-head{align-items:flex-start;flex-direction:column}.export-theme-mode{width:100%}.export-theme-mode button{flex:1}}`;
