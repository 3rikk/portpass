...
(function() {
  ...
  function initExportControls() {
    ...
    style.textContent = `.export-theme-controls{margin:12px 0 4px;padding:12px;border:1px solid var(--line);border-radius:10px;background:color-mix(in srgb,var(--surface) 92%,var(--paper));color:var(--ink)}.export-theme-head{display:flex;align-items:center;justify-content:space-between;gap:12px}.export-theme-head strong{display:block;font-size:11px}.export-theme-head small{display:block;margin-top:3px;color:var(--muted);font-size:9px}.export-theme-mode{border:1px solid var(--line);background:var(--palette-soft-3,#ecefe8);padding:3px;border-radius:8px;display:flex;gap:3px}.export-theme-mode button{padding:7px 12px;border-radius:6px;font-size:10px;color:var(--muted)}.export-theme-mode button.active{background:var(--surface);color:var(--ink);box-shadow:0 2px 5px #25372b0b}.export-palette-picker{display:flex;justify-content:center;gap:8px;margin-top:10px}.export-palette-picker button{width:18px;height:18px;min-width:18px;padding:0;border-radius:50%;border:1px solid color-mix(in srgb,var(--ink) 18%,transparent);background:var(--swatch);box-shadow:0 0 0 2px transparent}.export-palette-picker button.active{box-shadow:0 0 0 2px var(--surface),0 0 0 4px color-mix(in srgb,var(--ink) 48%,transparent)}.export-theme-controls[aria-busy="true"] button{opacity:.55;pointer-events:none}@media(max-width:480px){.export-theme-head{align-items:flex-start;flex-direction:column}.export-theme-mode{width:100%}.export-theme-mode button{flex:1}}`;
