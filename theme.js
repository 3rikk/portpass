...
`;
  ...
  function initAlphaWarning(){
    ...
    dialog.innerHTML=onAlpha
      ...
      : '<div class="dialog-heading"><div><div class="eyebrow">WARNING</div><h2 id="alpha-warning-title">Alpha site</h2></div><button type="button" class="close" aria-label="Close">×</button></div><p class="alpha-warning-copy">This is an advanced option. The alpha version of the site may have bugs. Check <a href="https://github.com/erikkunz/portpass/tree/alpha" target="_blank" rel="noopener">https://github.com/erikkunz/portpass/tree/alpha</a> to see what\'s new.</p><div class="alpha-actions"><button type="button" class="alpha-cancel">Cancel</button><button type="button" class="alpha-continue">Continue to alpha site</button></div>';
